...
public class FlightDTO {
    ...
    public FlightDTO(String id, Airport from, Airport to, String carrier, LocalDateTime departureTIme, LocalDateTime arrivalTime) {
        this.id = id;
        this.from = from;
        this.to = to;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(from, flightDTO.from)
                && Objects.equals(to, flightDTO.to)
